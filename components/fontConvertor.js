export var array_one = new Array(
   ...
   "ह्न", "ह्य", "हृ", "ह्म", "ह्र", "ह्", "द्द", "क्ष्", "क्ष", "त्र्", "त्र", "ज्ञ", "द्म",
...
export default function Convert_to_Walkman(unicodeString) {
   // unicode_to_walkman905
   ...
   var array_two = new Array(
      ...
      // "¹", "º", "^", "*", "¶", "¸", "»", "¹", "º", "@", "%", "¾", "A", "\\", "&", "&", "Œ", "]", "-", "~ ",
      // "ú", "û", "ü", "ý", "þ", "ÿ", "ö", "÷", "ø", "ù",
      "ú", "û", "ü", "ý", "þ", "ÿ", "ö", "÷", "ø", "ù", //"ñ", "$", "_",

      "Ý", "d", "[k", "x", "T", "t", "M+", "<+", "iQ", ";", "j", "u",
      "Ù", "Ùk", "ÙkQ", "n`", "Ñ",

      "É", "á", "â", "ã", "ß", "Þ", "í", "{", "{k", "=", "=k", "K", "Á",
      "NÔ", "VÔ", "BÔ", "MÔ", "<Ô", "|", "}",
      "J", "Vª", "Mª", "<ªª", "Nª", "Ø", "Ú", "æ", "ç", "xz", "#", ":",
      "z",

      "vks", "vkS", "vk", "v", "bZ", "b", "m", "Å", ",s", ",", "½",
   ...
   var modified_substring = unicodeString;

   Replace_Symbols();

   processed_text = modified_substring;

   let output = processed_text;
   ...
   function Replace_Symbols() {
      ...
      modified_substring = modified_substring.replace(/Zksa/g, "ks±");
      modified_substring = modified_substring.replace(/~ Z/g, "Z~");
      modified_substring = modified_substring.replace(/Zk/g, "kZ");
      modified_substring = modified_substring.replace(/Zh/g, "hZ");
      modified_substring = modified_substring.replace(/aZ/g, "±");
