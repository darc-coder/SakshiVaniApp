...
import { StyleSheet, ScrollView, Text, SafeAreaView, FlatList, ActivityIndicator } from 'react-native';
        ...
        if (allCategories) {
            return (
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <SingleSongCategory key={item} categoryName={item} categoryItemsArr={allCategories[item]} navigation={navigation} />
                    )}
                />
            )
        }
